				...
				<div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 quitar_padding">
					<div class="espacio_secciones justificar">
						<p class="text_medium p_texto_morado">
							El <span class="text_bold">TechDay</span> es el punto de encuentro para los profesionales de IT de todos los países de Centroamérica y Caribe, junto con las empresas líderes de Tecnologías de la Información a nivel mundial y <span class="text_bold">C&W Business</span> lo pone a tu alcance.
						</p>
						<br>
						<p class="text_medium p_texto_morado">
							Edición tras edición los asistentes a este evento son testigos de cómo esta experiencia sirve de plataforma para los más importantes anuncios, innovaciones y tendencias que marcarán la pauta en el Mercado IT en los años por venir.
						</p>
						<br>
						<p class="text_medium p_texto_morado">
			...
			<div class="row">
				<div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 quitar_padding">
					<div class="espacio_secciones centrar">
						<p class="text_medium p_texto_morado">
							Además podrás visitar nuestro stand de <span class="text_bold">C&W Business</span> y conocer los productos y servicios que ayudarán a tu negocio a llegar más lejos y a alcanzar tus metas.
						</p>
						<br>
				...
				<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
					<div id="div_contenedor_video">
						<video controls id="video_player" width="100%" height="100%">
						  ...
						  <source src="assets/videos/CBS-Datacenter-español-2015-_2.webm" type="video/webm">
						</video>
					</div>
				</div>
			</div>
					...
					<div id="div_contenedor_texto_derecho_formulario">
						...
						<p>
							<ul class="text_medium p_texto_negro">
								...
								<li>Security Transformation y su rol en la transformación digital</li>
								<li>Colaboración en Colaboraciones Unificadas</li>
								<li>Caso de Éxito (Invitado Especial)</li>
							</ul>
						</p>
						<p class="text_bold p_texto_negro">
							<span id="rosa">Lugar</span> <span class="mayuscula">Salón Dalí y Salón Picasso 3er Nivel</span>
						</p>
					</div>
				</div>
