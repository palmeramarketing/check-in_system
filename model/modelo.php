	...
	function envioCorreo($email) {
		...
		<body style="font-family: Helvetica; margin: 0px;">
			<table width="100%" height="100%" cellspacing="0" cellpadding="0" border="0" align="center">
				<tbody>
					<tr>
						<td align="center"><img src="../assets/images/menarini_icon.jpg" alt=""></td>
					</tr>
					<tr>
						<td><img src="../assets/images/gracias.jpg" alt="" width="100%"></td>
					</tr>
					<tr>
						<td align="center">
							<p style="font-size: 14pt;">Gracias por tu interés en participar <br>
							en nuestro evento:</p>
							<p style="font-size: 20pt;">IX Simposium de Centroamérica y el Caribe <br>
							de actualización en Odontoestomatología</p>
							<p style="font-size: 14pt;">Uno de nuestros representantes <br>
